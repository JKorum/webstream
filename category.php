...
if (!isset($_GET['id'])) {
  $error = ErrorRender::show('No category id provided to the page.');
} else {
  $username = $_SESSION["userLoggedIn"];
  $preview = new PreviewProvider($con, $username);
  $categories = new CategoryContainers($con, $username);

  $previewHtml = $preview->createCategoryPreviewVideo($_GET['id']);

  $categoriesHtml = $categories->showCategory($_GET['id'], null, null);
}
